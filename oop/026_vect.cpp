...
namespace VECTOR
{
    //compute degrees in one radin;should be about 57.2957795130823
    ...
    //constructor vector from rectangle coordinates if form is r
